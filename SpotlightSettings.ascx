...
<div class="Settings">
	<dl>
		...
		<dd>
			<dnn:DnnNumericTextBox runat="server" ID="rntxtMeetingMaxDayCount" CssClass="right" Width="50px" MaxLength="3" MinValue="0" MaxValue="999" NumberFormat-DecimalDigits="0" />
		</dd>
		...
		<dd>
			<dnn:DnnNumericTextBox ID="txtPageSize" runat="server" CssClass="NormalTextBox right" MaxLength="2" Width="50px" MinValue="1" MaxValue="99" NumberFormat-DecimalDigits="0"  />
		</dd>
		<dt><dnn:label id="lblWidgetHeight" runat="server" controlname="txtWidgetHeight" suffix=":" CssClass="SubHead" /></dt>
		<dd>
			<dnn:DnnNumericTextBox ID="txtWidgetHeight" runat="server" CssClass="NormalTextBox right" MaxLength="3" Width="50px" MinValue="20" MaxValue="999" NumberFormat-DecimalDigits="0"  />
		</dd>
		<dt><dnn:label id="lblWidgetWidth" runat="server" controlname="txtWidgetWidth" suffix=":" CssClass="SubHead" /></dt>
		<dd>
			<dnn:DnnNumericTextBox ID="txtWidgetWidth" runat="server" CssClass="NormalTextBox right" MaxLength="3" Width="50px" MinValue="20" MaxValue="999" NumberFormat-DecimalDigits="0"  />
		</dd>
		<dt><dnn:label id="lblItemHeight" runat="server" controlname="txtItemHeight" suffix=":" CssClass="SubHead" /></dt>
		<dd>
			<dnn:DnnNumericTextBox ID="txtItemHeight" runat="server" CssClass="NormalTextBox right" MaxLength="3" Width="50px" MinValue="20" MaxValue="999" NumberFormat-DecimalDigits="0"  />
		</dd>
		<dt><dnn:label id="lblItemWidth" runat="server" controlname="txtItemWidth" suffix=":" CssClass="SubHead" /></dt>
		<dd>
			<dnn:DnnNumericTextBox ID="txtItemWidth" runat="server" CssClass="NormalTextBox right" MaxLength="3" Width="50px" MinValue="20" MaxValue="999" NumberFormat-DecimalDigits="0" />
		</dd>
		<dt><dnn:label id="lblFrameDuration" runat="server" controlname="txtFrameDuration" suffix=":" CssClass="SubHead" /></dt>
		<dd>
			<dnn:DnnNumericTextBox ID="txtFrameDuration" runat="server" CssClass="NormalTextBox right" MaxLength="6" Width="50px" MinValue="100" MaxValue="100000" NumberFormat-DecimalDigits="0" />
		</dd>
		<dt><dnn:label id="lblScrollDuration" runat="server" controlname="txtScrollDuration" suffix=":" CssClass="SubHead" /></dt>
		<dd>
			<dnn:DnnNumericTextBox ID="txtScrollDuration" runat="server" CssClass="NormalTextBox right" MaxLength="6" Width="50px" MinValue="100" MaxValue="100000" NumberFormat-DecimalDigits="0" />
		</dd>
	</dl>
</div>