...
<div class="Settings">
	<dl>
		...
		<dd>
			<dnn:DnnNumericTextBox ID="rntxtMinGroupSize" runat="server" ShowSpinButtons="true" MinValue="1" MaxValue="54" Width="54" />
		</dd>
		...
		<dd>
			<dnn:DnnNumericTextBox ID="rntxtPageSize" runat="server" ShowSpinButtons="true" MinValue="1" MaxValue="50" Width="54" />
		</dd>
		<dt><dnn:label id="dnnlblNameFormat" runat="server" controlname="rcbNameFormat" suffix=":" CssClass="SubHead" /></dt>
		<dd>
			<dnn:DnnComboBox ID="rcbNameFormat" runat="server" Width="254" />
		</dd>
		...
		<dd>
			<dnn:DnnComboBox ID="rcbProfileProperty" runat="server" Width="254" DataTextField="PropertyName" DataValueField="PropertyDefinitionID" />
		</dd>
	</dl>
</div>