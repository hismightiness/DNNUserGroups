...
<div class="usergroup-module">
	...
	<div class="ug-actions">
		<div class="ug-connect">
        	...
        	<dnn:DnnGrid ID="rgMembers" runat="server" AutoGenerateColumns="false" GridLines="None" OnItemDataBound="RgMembersItemDataBound" Width="218px" AllowSorting="false" >
			...
			<MasterTableView DataKeyNames="UserID,Username,DisplayName,Officer,LeaderID" AllowNaturalSort="false" TableLayout="Fixed">
				<Columns>
					<dnn:DnnGridHyperLinkColumn UniqueName="Name" HeaderText="Name" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" Target="_blank" HeaderStyle-Width="150px" ItemStyle-Width="150px" />
					<dnn:DnnGridImageColumn UniqueName="Officer" HeaderText="Officer" HeaderStyle-Width="35px" ItemStyle-Width="35px" ItemStyle-HorizontalAlign="Center" />
				</Columns>
			</MasterTableView>
		</dnn:DnnGrid>
    ...
    <div class="ug-upcoming" id="divEvents" runat="server" visible="false">
		...
		<dnn:DnnGrid ID="rgMeetings" runat="server" AutoGenerateColumns="false" GridLines="None" Width="628px" OnItemCommand="RgMeetingsItemCommand" OnItemDataBound="RgMeetingsItemDataBound">
			<ClientSettings AllowColumnsReorder="false" EnableRowHoverStyle="false">
			</ClientSettings>
			<MasterTableView DataKeyNames="MeetingID,UserGroupID" AllowNaturalSort="false">
				<Columns>
					...
					<dnn:DnnGridHyperLinkColumn UniqueName="Title" HeaderText="Title" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="200" HeaderStyle-Width="200" DataTextField="Title" />
					...
					<dnn:DnnGridBoundColumn UniqueName="Date" HeaderText="Date" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" DataField="MeetingDate" />
				</Columns>
			</MasterTableView>
		</dnn:DnnGrid>
	</div>
